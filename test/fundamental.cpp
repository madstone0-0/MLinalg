...
TEST_CASE("Matrix", "[matrix]") {
    ...
    SECTION("Robustness") {
        ...
        SECTION("Matrix addition with zero-dimension matrices") {
            auto m1 = Matrix<int, 0, 0>{};
            auto m2 = Matrix<int, 0, 0>{};
            auto m3 = m1 + m2;
            REQUIRE(m3.numRows() == 0);
            REQUIRE(m3.numCols() == 0);
        }

        SECTION("Matrix subtraction with zero-dimension matrices") {
            auto m1 = Matrix<int, 0, 0>{};
            auto m2 = Matrix<int, 0, 0>{};
            auto m3 = m1 - m2;
            REQUIRE(m3.numRows() == 0);
